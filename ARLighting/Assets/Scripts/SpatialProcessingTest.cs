...
// Derived from https://github.com/Microsoft/MixedRealityToolkit
//
...
namespace ARLighting
{
    ...
    public class SpatialProcessingTest : Singleton<SpatialProcessingTest>
    {
        ...
        [Tooltip("Colleciton of holograms to be disabled during scanning/processing mode.")]
        public GameObject hologramsCollection;
        ...
        private void Start()
        {
            ...
            // Disable collection of holograms
            if (hologramsCollection)
            {
                hologramsCollection.SetActive(false);
            }
        }
        ...
        private void Update()
        {
            ...
            if (!meshesProcessed)
            {
                ...
                else
                {
                    ...
                    // Enable collection of holograms
                    if (hologramsCollection)
                    {
                        hologramsCollection.SetActive(true);
                    }
                }
            }
        }
        ...
        private void SurfaceMeshesToPlanes_MakePlanesComplete(object source, System.EventArgs args)
        {
            ...
            if (floors.Count >= minimumFloors)
            {
                ...
                // After scanning is over, switch to the secondary (occlusion) material if available, else don't draw SpatialMapping
