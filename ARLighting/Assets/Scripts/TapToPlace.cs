...
namespace ARLighting
{
    ...
    public class TapToPlace : MonoBehaviour, IInputClickHandler
    {
        ...
        [Tooltip("Should the top or bottom of the Collider be used for placement.")]
        public bool UseBottomForPlacement = true;
        ...
        private float PlacementBottomOffset;
        ...
        private void OnEnable()
        {
            ...
            if (UseBottomForPlacement)
            {
                PlacementBottomOffset = bounds.center.y - bounds.min.y;
            }
            else
            {
                PlacementBottomOffset = bounds.center.y - bounds.max.y;
            }
        }
        ...
        protected virtual void Update()
        {
            ...
            placementPosition.y += PlacementBottomOffset;
